...
def vyhoď_základnírvar_upravené(čitatel_1, jmenovatel_1, čitatel_2,jmenovatel_2):
...
class zlomek:
    ...
    def vynásob(self, druhý_čitatel, druhý_jmenovatel):
        l = vyhoď_základnírvar_upravené(self.čitatel, self.jmenovatel, druhý_čitatel, druhý_jmenovatel)
